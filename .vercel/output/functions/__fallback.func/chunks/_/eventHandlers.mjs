import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { w as prefixStorage, x as useStorage, y as useNitroOrigin, z as emojiCache, A as useOgImageRuntimeConfig, j as createError, B as fetchIsland, C as createHeadCore, D as normaliseFontInput, E as theme, F as withTrailingSlash, i as getQuery, G as handleCacheHeaders, H as setHeaders, I as setHeader, J as hash, K as parseURL, L as setResponseHeader, M as proxyRequest, N as sendRedirect, O as resolveContext, P as H3Error } from './nitro.mjs';
