import { v as vueExports, w as useAppConfig, z as tv, A as serverRenderer_cjs_prodExports, H as _sfc_main$c, _ as _sfc_main$g } from './server.mjs';
import '../_/nitro.mjs';
import 'lru-cache';
import '@unocss/core';
...
const _sfc_main = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.to) {
        _push(serverRenderer_cjs_prodExports.ssrRenderComponent(_sfc_main$c, vueExports.mergeProps({ "aria-label": ariaLabel.value }, { to: __props.to, target: target.value, ..._ctx.$attrs }, {
      ...
      if (__props.icon) {
        _push(serverRenderer_cjs_prodExports.ssrRenderComponent(_sfc_main$g, {
          name: __props.icon,
      ...
      if (__props.title || !!slots.title) {
        _push(`<p class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.title({ class: props.ui?.title }))}">`);
        serverRenderer_cjs_prodExports.ssrRenderSlot(_ctx.$slots, "title", { mdcUnwrap: "p" }, () => {
      ...
      if (!!slots.default) {
        _push(`<div class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.description({ class: props.ui?.description }))}">`);
        serverRenderer_cjs_prodExports.ssrRenderSlot(_ctx.$slots, "default", {}, () => {
          _push(`${serverRenderer_cjs_prodExports.ssrInterpolate(__props.description)}`);
        }, _push, _parent);
        _push(`</div>`);
      } else {
        _push(`<!---->`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.2.1_@babel+parse_c8c45511c3ca5af34ce239e30ac6bdb3/node_modules/@nuxt/ui/dist/runtime/components/prose/Card.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=Card-CRQELOKY.mjs.map
