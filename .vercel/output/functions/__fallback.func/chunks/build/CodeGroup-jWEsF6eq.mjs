                    ...
                    _push3(serverRenderer_cjs_prodExports.ssrRenderComponent(vueExports.unref(TabsTrigger_default), {
                      ...
                      default: vueExports.withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          ...
                          _push4(`<span class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.triggerLabel({ class: props.ui?.triggerLabel }))}"${_scopeId3}>${serverRenderer_cjs_prodExports.ssrInterpolate(item.label)}</span>`);
                        } else {
                          return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.2.1_@babel+parse_c8c45511c3ca5af34ce239e30ac6bdb3/node_modules/@nuxt/ui/dist/runtime/components/prose/CodeGroup.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=CodeGroup-jWEsF6eq.mjs.map
