import { v as vueExports, w as useAppConfig, z as tv, A as serverRenderer_cjs_prodExports, _ as _sfc_main$g, j as createContext, l as useCollection, P as Primitive, h as useVModel, d as createEventHook, g as getActiveElement } from './server.mjs';
...
import { M as MAP_KEY_TO_FOCUS_INTENT } from './utils-CEewrpIs.mjs';
...
const _sfc_main = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    const model = vueExports.ref(props.defaultValue ? { path: props.defaultValue } : void 0);
    ...
    const expanded = vueExports.computed(() => {
      if (props.expandAll) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
        ...
        default: vueExports.withCtx(({ items: items2, level }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            serverRenderer_cjs_prodExports.ssrRenderList(items2, (item, index) => {
              _push2(`<li role="presentation" class="${serverRenderer_cjs_prodExports.ssrRenderClass(level > 1 ? ui.value.itemWithChildren({ class: props.ui?.itemWithChildren }) : ui.value.item({ class: props.ui?.item }))}"${_scopeId}>`);
              _push2(serverRenderer_cjs_prodExports.ssrRenderComponent(vueExports.unref(TreeItem_default), {
                ...
                default: vueExports.withCtx(({ isExpanded, isSelected }, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<button type="button" class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.link({ class: props.ui?.link, active: isSelected }))}"${_scopeId2}>`);
                    ...
                    _push3(`<span class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.linkLabel({ class: props.ui?.linkLabel }))}"${_scopeId2}>${serverRenderer_cjs_prodExports.ssrInterpolate(item.label)}</span>`);
                    if (item.children?.length) {
                      _push3(`<span class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.linkTrailing({ class: props.ui?.linkTrailing }))}"${_scopeId2}>`);
                      _push3(serverRenderer_cjs_prodExports.ssrRenderComponent(_sfc_main$g, {
                    ...
                    if (item.children?.length && isExpanded) {
                      _push3(`<ul role="group" class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.listWithChildren({ class: props.ui?.listWithChildren }))}"${_scopeId2}>`);
      ...
      _push(`<div class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.content({ class: props.ui?.content }))}">`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.2.1_@babel+parse_c8c45511c3ca5af34ce239e30ac6bdb3/node_modules/@nuxt/ui/dist/runtime/components/prose/CodeTree.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=CodeTree-C6aX3glE.mjs.map
