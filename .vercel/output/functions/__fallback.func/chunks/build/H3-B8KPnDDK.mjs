import { w as useAppConfig, O as useRuntimeConfig, v as vueExports, z as tv, A as serverRenderer_cjs_prodExports, _ as _sfc_main$g } from './server.mjs';
import '../_/nitro.mjs';
import 'lru-cache';
import '@unocss/core';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.id && generate.value) {
        _push(`<a${serverRenderer_cjs_prodExports.ssrRenderAttr("href", `#${__props.id}`)} class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.link({ class: props.ui?.link }))}"><span class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.leading({ class: props.ui?.leading }))}">`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.2.1_@babel+parse_c8c45511c3ca5af34ce239e30ac6bdb3/node_modules/@nuxt/ui/dist/runtime/components/prose/H3.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=H3-B8KPnDDK.mjs.map
