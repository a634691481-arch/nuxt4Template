...
const _sfc_main = {
  ...
  setup(__props) {
    const props = __props;
    const org = vueExports.computed(() => props.title.split("/")[0]);
    const repo = vueExports.computed(() => props.title.split("/")[1]);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt-og-image@5.1.12_@unhea_a763cc5bc9d4b73d6b88affead04df2d/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/UnJs.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=UnJs-CnzRaoCC.mjs.map
