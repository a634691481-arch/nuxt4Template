import { v as vueExports, ak as isDef } from './server.mjs';
...
class FeatureManager {
  constructor(state) {
    ...
    vueExports.watch(lazyMotionContext.features, (features2) => {
...
function useAnimatePresence(props) {
  ...
  vueExports.watch(() => props.custom, (v) => {
...
function handlePrimitiveAndSlot(asTag, allAttrs, slots) {
  ...
  if (typeof asTag === "string" && SELF_CLOSING_TAGS.includes(asTag)) {
    return vueExports.h(asTag, allAttrs);
  }
  if (asTag === "template") {
    if (!slots.default)
      return null;
...
export { Motion as M, useMotionConfig as a, mountedStates as b, doneCallbacks as d, frame as f, motion as m, removeDoneCallback as r, useAnimatePresence as u };
//# sourceMappingURL=index-CNniXDIx.mjs.map
