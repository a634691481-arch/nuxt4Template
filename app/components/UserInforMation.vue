<template>
  <div
    class="justify-evenly size-full dark:bg-neutral-900/75 border-white/40 dark:border-neutral-800 text-neutral-800 dark:text-neutral-200 flex flex-col items-center bg-white border"
  >
    <div class="size-16">
      <UAvatar :src="props.user.avatar" :name="props.user.name" size="20" />
    </div>

    <div class="text-neutral-900 dark:text-neutral-100 text-sm font-semibold text-center">
      {{ props.user.name }}
    </div>
    <div class="text-neutral-600 dark:text-neutral-400 text-xs text-center">共 9999 张照片</div>
    <div class="text-neutral-700 dark:text-neutral-200 flex items-center gap-1">
      <!-- 上传图片 -->
      <UTooltip text="上传图片">
        <UButton color="primary" variant="soft" icon="i-heroicons-cloud-arrow-up-20-solid" @click="uploadImage" />
      </UTooltip>
      ...
      <UTooltip text="主题色">
        ...
        >
          <UButton color="primary" variant="soft" icon="i-heroicons-swatch-20-solid" />
        </UDropdownMenu>
      </UTooltip>
      <!-- 筛选 -->
      <UTooltip text="筛选">
        ...
        >
          <UButton color="primary" variant="soft" icon="i-heroicons-funnel-20-solid" />
        </UDropdownMenu>
      </UTooltip>
      <!-- 刷新 -->
      <UTooltip text="刷新">
        <UButton color="primary" variant="soft" icon="i-heroicons-arrow-path-20-solid" @click="refreshItems" />
      </UTooltip>
      <!-- 明暗切换 -->
      <UTooltip text="明暗切换">
        <UButton
