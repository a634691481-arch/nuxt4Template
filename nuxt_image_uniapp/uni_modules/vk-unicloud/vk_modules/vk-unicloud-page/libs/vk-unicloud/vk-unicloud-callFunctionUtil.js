				...
				cloudStorage[provider].uploadFile(obj)
					...
					.finally(() => {
						...
						if (logMode === 1) {
							...
							console.groupCollapsed(`%c--------【${requestStatus}】【${providerName}-文件上传】【${Logger.runTime}ms】--------`,
	...
	callFunctionComplete(obj) {
		...
		if (debugLog) {
			...
			if (logMode === 1) {
				...
				if (typeof console.groupCollapsed === "function") console.groupCollapsed(
